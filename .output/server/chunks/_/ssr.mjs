  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/ezraharris/Documents/Enviroment Testing/computational/.output/public";
        const {
          promises: fs2
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-B8HY4AtX.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-CHX1fIQp.mjs');
    default:
...
const appCss = "/assets/app-DLDAlzwe.css";
...
const $$splitComponentImporter = () => import('./index-SUyNzZ16.mjs');
